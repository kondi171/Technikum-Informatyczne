<?php
	...
	if (isset($_POST['email']))
	{
		...
		$sekret="6LddpCEUAAAAAHafBL1lg6D3o9Amvn6bnUHVrn4a";
...
<head>
	...
	<title>Cerca Trova- załóż darmowe konto!</title>
	<link href="https://fonts.googleapis.com/css?family=Archivo+Black" rel="stylesheet">
	<link rel="stylesheet" href="css/fontello.css" type="text/css" />
	<link href="https://fonts.googleapis.com/css?family=Barrio" rel="stylesheet">
	<script src='https://www.google.com/recaptcha/api.js'></script>
	<link href="style/rejestracja.css" rel="stylesheet" type="text/css" />
	<style>
		.error
		{
			color:red;
...
<div id="container">
<div id="logo">
<font color="gold">Cerca</font>Trova - Zarejestruj się!
</div>
	<div id ="rej">
	...
	<form method="post">
		...
		<label>
			...
			if (isset($_SESSION['fr_regulamin']))
			{
				...
				?>/> Akceptuję<a href="regulamin.html" target="_blank"> regulamin</a>
		</label>
		...
		?>	
			<div class="g-recaptcha" data-sitekey="6LddpCEUAAAAAP4yoC4fM7B8ktMHXvvDeGj6H42k"></div>
		<?php
	...
	<div id="motto">Let's Do it, We offer you everything!</div>
</div>
<div id="footer">
	<div id="media">
			<div class="insta">
