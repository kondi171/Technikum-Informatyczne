...
<div class="pojemnik">
	...
	<div class="pojemnik">
					...
					<div id="header">Poczta - Wiadomość</div>
		<br>
		<br>
...
$wynik= $link -> query ("UPDATE ".$odebrane." SET stan=1 WHERE id='".$_POST['id']."'")or die ("blad w zapytaniu1");
$wynik = $link -> query ("select * from ".$odebrane." where id='".$_POST['id']."'") or die ("blad w zapytaniu5!");
echo "<table border=5 style='width: 80%; height: 15em'>";
while ($rek = $wynik ->fetch_assoc())
{
	
	echo "<tr><td>".$rek['uzytkownik']."</td><td>".$rek['data']."</td><td>".$rek['tresc']."</td><td>";
...
echo "</table>
								<br>
						<div class='post'><a href='poczta.php' class='post'>Odebrane</a></div>
								<br>
