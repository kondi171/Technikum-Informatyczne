...
<div id="content">
<center>
		<form action="towar.php" enctype="multipart/form-data" method="POST">
Nazwa towaru: <br><input type="text" name="name"><br>
<input type="hidden" name="MAX_FILE_SIZE" value="6120000" />
Dodaj zdjęcie: <br><input type="file" name="plik" ><br>
Cena :<br> <input type="text" name="cena"><br>
Szt. : <br><input type="text" name="ile"><br>
<input type="submit" value="Wystaw na sprzedaż">
</form>
</center>
</div>
</div>
